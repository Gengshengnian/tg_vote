  ...
  BUI.use('common/search',function (Search) {
    ...
    var enumObj = {"1":"男","0":"女"},
      ...
      columns = [
		  ...
		  {title : '知识点',dataIndex :'knowledge_name'}, //editor中的定义等用于 BUI.Form.Field.Text的定义
          {title : '学生姓名',dataIndex : 'student_name'},
          {title : '问题',dataIndex : 'problem'},
          {title : '备注',dataIndex : 'comment'},
        ],
      store = Search.createStore('problem_detail'+"?date=<?php echo ($date); ?>&class_id=<?php echo ($class_id); ?>&knowledge_id=<?php echo ($knowledge_id); ?>&master_level=<?php echo ($master_level); ?>",{
        proxy : {
