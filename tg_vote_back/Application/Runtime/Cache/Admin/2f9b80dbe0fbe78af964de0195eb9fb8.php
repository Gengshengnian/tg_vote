     ...
     <form id ="J_Form" class="form-horizontal">
      ...
      <div class="row">
        <div class="control-group span12">
          ...
          <div class="controls">
            <input name="id" type="text" class="control-text" readonly>
          </div>
        </div>
        <div class="control-group span12">
          <label class="control-label">客户姓名：</label>
      ...
      <div class="row">
        ...
        <div class="control-group span12">
          <label class="control-label"><s>*</s>申请金额：</label>
          <div class="controls">
      ...
      <div class="row">
          ...
          <div class="controls control-row4">
            <textarea name="reason" class="span15 span-width"></textarea><span>(200字内)</span>
          </div>
        </div>
      ...
      <div class="row">
          ...
          <div class="controls control-row4">
            <textarea name="comment" class="span15 span-width"></textarea><span>(200字内)</span>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="row">
        <div class="control-group span12">
          <label class="control-label">办理申请：</label>
          <div class="controls" >
...
<script type="text/javascript">
  ...
  BUI.use('common/search',function (Search) {
	  var applyStatus = {"0":"待审批","1":"拒绝","2":"同意"},//2待业，1在职，0在读
	  type = {"0":"申请调价","1":"申请退费"},
      ...
      columns = [
          ...
          {title:'申请类型',dataIndex:'type',width:200,renderer:BUI.Grid.Format.enumRenderer(type)},
          {title:'申请人',dataIndex:'rname',width:200},
          {title:'申请时间',dataIndex:'addtime',width:200},
          {title:'状态',dataIndex:'status',width:200,renderer:BUI.Grid.Format.enumRenderer(applyStatus)},
          {title:'操作',dataIndex:'',width:200,renderer : function(value,obj){
              editStr1 = '<span class="grid-command btn-edit" title="审批">审批</span>';
            return editStr1;
          }}
        ],
      store = Search.createStore("<?php echo U('getWaitData');?>",{
        proxy : {
