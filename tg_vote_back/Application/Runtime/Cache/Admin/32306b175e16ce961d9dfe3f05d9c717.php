...
<script type="text/javascript">
  BUI.use('common/search',function (Search) {
      ...
      editing = new BUI.Grid.Plugins.DialogEditing({
		...
		columns = [
          {title:'客户id',dataIndex:'client_id',width:100},
          {title:'客户名字',dataIndex:'clientname',width:80},
          {title:'负责人',dataIndex:'respname',width:80},
          {title:'应缴费用',dataIndex:'ypay',width:130},
          {title:'实缴费用',dataIndex:'totalspay',width:60},
          {title:'欠费',dataIndex:'sheng',width:60}
         
        ],
       store = Search.createStore('<?php echo U("getowe");?>',{
        proxy : {
