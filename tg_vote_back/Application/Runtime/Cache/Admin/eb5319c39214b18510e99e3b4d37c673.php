...
<body>
	<center>
		<form action="<?php echo U('latereport');?>" method="POST">
			<table width="800" border="1" cellpadding="0" cellspacing="0">
				<caption>
						...
						<hr>
						<h4>
							实交日期：<input type="date" name="date" value="<?php echo ($todayKnowkedges[0]['date']); ?>" readonly />　　　
							应交日期：<input type="date" name="laterdate" value=""/>
