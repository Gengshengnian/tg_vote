  ...
  <div id="content" class="hide">
     <form id ="J_Form" class="form-horizontal" >
		<div class="row">
        	...
        	<div class="control-group span10">
		         <label class="control-label"><s>*</s>推荐公司：</label>
		          <div class="controls" >
			            <select name="direction">
	    ...
	    <div class="row">
	    	<div class="control-group span10">
		         <label class="control-label"><s>*</s>面试时间：</label>
		          <div class="controls" >
							 <input data-rules="{required:true}" name="time" type="text" class="calendar" data-rules="{date:true}">
		          </div>
        	</div>
		</div>
      </form>
...
BUI.use('common/search',function (Search) {
    ...
    columns = [
		...
		{title:'推荐公司',dataIndex:'company',width:100},
		{title:'面试时间',dataIndex:'time',width:100},
        {title:'操作',dataIndex:'',width:200,renderer : function(value,obj){
          	  editStr1 = '<span class="grid-command btn-edit " title="推荐">推荐</span>',
                delStr = '<span class="grid-command btn-del" title="编辑">编辑</span>';//页面操作不需要使用Search.createLink
