      ...
      <form id="J_Form" class="form-horizontal" action="../data/edit.php?a=1">
        <input type="hidden" name="a" value="3">
          <div class="row">
	          ...
	          <div class="control-group span9">
	            <label class="control-label"><s>*</s>知识点：</label>
	            <div class="controls">
	              <input type="text"  name="tep_point">
	            </div>
	          </div>
        </div>
        <div class="row">
  ...
  BUI.use('common/search',function (Search) {
    ...
    var enumObj = {"0":"未做","1":"已做","2":"<font color=red>已阅</font>"},
      ...
      columns = [
          ...
          {title:'试卷编号',dataIndex:'tep_code',width:100},
          {title:'知识点',dataIndex:'name',width:80},
          {title:'添加日期',dataIndex:'tep_addtime',width:120},
          {title:'状态',dataIndex:'tep_status',width:100,renderer:BUI.Grid.Format.enumRenderer(enumObj)},
          {title:'建议考试时间',dataIndex:'tep_timelong',width:300},
