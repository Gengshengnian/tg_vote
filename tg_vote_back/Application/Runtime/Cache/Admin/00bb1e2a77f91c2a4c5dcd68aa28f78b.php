   ...
   <link href="/tg_oa_crm_20161008/Public/bui/Common/assets/css/prettify.css" rel="stylesheet" type="text/css" />
	...
	<script type="text/javascript">
			function getStages(obj,firstLevelName,secondLevelName)
			{
				...
				$.ajax({
					type:"post",
					url:"/tg_oa_crm_20161008/index.php/Admin/DayScores/getSecondLevelResourses",
			...
			/* function getExport(){
				...
				$.ajex({
					type:"post",
					url:"/tg_oa_crm_20161008/index.php/Admin/DayScores/search",
              ...
              <div class="row">
				 <div class="control-group span10">
                  ...
                  <div class="controls">
                    	<select name="name">
			              <option value="0">请选择</option>
			              <?php if(is_array($stu)): $i = 0; $__LIST__ = $stu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["name"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
			            </select>
                  </div>
                </div>
      ...
      columns = [
          ...
          {title:'统计图',dataIndex:'',width:100,renderer : function(value,obj){
        	  viewCouTableStr =  Search.createLink({ //链接使用 此方式
                  ...
                  title : '查看统计图',
                  text : '查看统计图',
                  href : '<?php echo U("paint");?>'+"?id="+obj.id
                }),
