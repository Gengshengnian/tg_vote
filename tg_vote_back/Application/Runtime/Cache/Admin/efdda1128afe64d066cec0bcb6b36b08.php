  ...
  BUI.use(['common/search','common/page'],function (Search) {
    ...
    var enumObj = {"1":"男","0":"女"},
      columns = [
          ...
          {title:'讲师',dataIndex:'name',width:400},
          {title:'本月课时',dataIndex:'num',width:80,renderer:function(value,obj){
              return Search.createLink({
                id : 'detail' + obj.id + obj.name,
                title : '本月课时',
                text : value,
                href : '<?php echo U("getindex");?>'+"?name="+obj.name 
              });
            }},
