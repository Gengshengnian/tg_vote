 ...
 <body>
  ...
  <div id="content" class="hide">
     <form id ="J_Form" class="form-horizontal" >
      <div class="row">
         <div class="control-group span8">
          <label class="control-label"><s>*</s>部门名字：</label>
          <div class="controls">
    ...
    <div class="row">
      <div class="control-group span8">
        ...
        <div class="controls" id="s1">
          <input type="text" id="show" name="parent_id" class="input-normal control-text">
...
BUI.use('common/search',function (Search) {
    ...
    columns = [
        ...
        {title:'部门描述',dataIndex:'description',width:100},
  ...
  grid.on('cellclick',function(ev){
    ...
    BUI.use(['bui/extensions/treepicker','bui/tree','bui/data'],function(TreePicker,Tree,Data){
        ...
        var store2 = new Data.TreeStore({
            ...
            url : "<?php echo U('HrDepartment/trees');?>",
            autoLoad : true/**/
          }),
