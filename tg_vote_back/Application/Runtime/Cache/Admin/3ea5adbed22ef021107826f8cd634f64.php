 ...
 <body>
  ...
  <!--       <div class="control-group span8">
        ...
        <div class="control-group span8">
          ...
          <div class="controls">
            <input type="text" class="control-text" name="dname">
          </div>
        </div>
     ...
     <!--  <h3>基本信息</h3>
      ...
      <div class="row">
        <div class="control-group span12">
          ...
          <div class="controls">
            <input name="grade" type="text" class="control-text" data-rules="{required:true}">
          </div>
        </div>
      ...
      <div class="row">
        <div class="control-group span12">
          ...
          <div class="controls">
            <input name="linkmen" type="text" class="control-text" data-rules="{required:true}">
          </div>
        </div>
      ...
      <div class="row">
          ...
          <label class="control-label">意向课程：</label>
          <div class="controls">
            <input name="course" type="text" class="control-text" data-rules="{required:true}">
          </div>
        </div>
        <div class="control-group span12">
          <label class="control-label">最近跟进：</label>
          <div class="controls">
            <input type="text" class=" calendar" name="follow">
          </div>
        </div>
        ...
        <div class="control-group span4">
          <h2><label class="control-label">确认要推送吗？</label></h2>
          <div class="controls" >
...
<script type="text/javascript">
  BUI.use('common/search',function (Search) {
	  var completed = {"0":"<font color=red>未完成<font>","1":"完成"},
	  result = {"1":"未报名","2":"报名","3":"<font color=green>缴费</font>","4":"进班","5":"放弃"},
	  state = {"1":"在校","2":"在职","3":"待业"},
      ...
      columns = [
          ...
          {title:'联系电话',dataIndex:'tel',width:100},
          {title:'意向课程',dataIndex:'dname',width:60},
          {title:'现在状态',dataIndex:'state',width:60,renderer:BUI.Grid.Format.enumRenderer(state)},
         /*  {title:'学校',dataIndex:'school',width:100},
          {title:'专业',dataIndex:'major',width:100},
          {title:'年级',dataIndex:'grade',width:50}, */
          {title:'最近跟进',dataIndex:'followtime',width:100},
          {title:'下次跟进',dataIndex:'next_follow',width:100},
          {title:'是否跟进',dataIndex:'completed',width:60,renderer:BUI.Grid.Format.enumRenderer(completed)},
          {title:'跟进结果',dataIndex:'result',width:60,renderer:BUI.Grid.Format.enumRenderer(result)},
          {title:'负责人',dataIndex:'rname',width:100},

        ],
      store = Search.createStore('<?php echo U("getNowdata");?>',{
        proxy:{
