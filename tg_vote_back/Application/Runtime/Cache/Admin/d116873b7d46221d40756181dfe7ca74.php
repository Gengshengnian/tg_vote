      ...
      <form id="searchForm" class="form-horizontal span24">
        <div class="row">
          <div class="control-group span7">
            <label class="control-label">规则标题：</label>
            <div class="controls">
              <input type="text" class="control-text" name="rule_name">
            </div>
          </div>
          <div class="control-group span7">
            <label class="control-label">标题内容：</label>
            <div class="controls">
              <input type="text" class="control-text" name="rule_content">
            </div>
          </div>
          <div class="span3 ">
      ...
      <form id="J_Form" class="form-horizontal" action="<<?php echo U('User/doadd');?>>">
        ...
        <div class="row">
          <div class="control-group span8">
            <label class="control-label"><s>*</s>规则标题</label>
            <div class="controls">
              <input name="rule_name" type="text" data-rules="{required:true}" class="input-normal control-text">
            </div>
          </div>
          </div>
        <div class="row">
          <div class="control-group span8">
            ...
            <div class="controls">
				<input name="rule_content" type="text" class="input-normal control-text">
        ...
        <div class="row">
           <div class="control-group span8">
            ...
            <div class="controls">
        <input name="comment" type="text" class="input-normal control-text">
...
<script type="text/javascript">
  BUI.use('common/search',function (Search) {
      ...
      columns = [
          ...
          {title:'规则标题',dataIndex:'rule_name',width:200},
          {title:'规则内容',dataIndex:'rule_content',width:400},
