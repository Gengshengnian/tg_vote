      ...
      <form id="searchForm" class="form-horizontal span24" action="<?php echo U('getdata');?>" method = "POST">
        <div class="row">
          <div class="control-group span8">
            ...
            <div class="controls" >
              	<input type="text" class="control-text" name="class">
            </div>
          </div>
          <div class="control-group span8">
     ...
     <form id ="J_Form" class="form-horizontal" >
      <div class="row">
        <div class="control-group span10">
          ...
          <div class="controls">
            <input name="class" type="text" class="control-text" data-rules="{required:true}">
          </div>
        </div>
      </div>
       <div class="row">
  ...
  BUI.use('common/search',function (Search) {
    ...
    var enumObj = {"1":"男","0":"女"},
      ...
      columns = [
          ...
          {title:'用户id',dataIndex:'uid',width:100,visible:false},
          {title:'应交日期',dataIndex:'date',width:60},
          {title:'操作',dataIndex:'',width:200,renderer : function(value,obj){
           // console.log(obj);
        	  var editStr =  Search.createLink({ //链接使用 此方式
                ...
                title : '补交日报',
                text : '补交日报',
                href : '/tg_oa_crm_20161008/index.php/Admin/StudentReport/later/id/'+obj.uid
                //'<?php echo U("studentdetails?id='+obj.id+'");?>'
              }),
      ...
      store = Search.createStore("getnoreport",{
        proxy : {
