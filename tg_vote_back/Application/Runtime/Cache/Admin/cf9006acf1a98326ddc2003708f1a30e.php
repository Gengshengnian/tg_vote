...
<head>
	<meta charset="UTF-8">
	<title>login</title>
	<link rel="stylesheet" href="/weixin/web/tg_vote_back/Public/css/0-login.css">
</head>
<body>
	<!--logo start-->
	<div class="wlh-heardbox">
		<img src="/weixin/web/tg_vote_back/Public/image/logo1-0.png" alt="">
	</div>
	<!--logo end-->
	<!--内容 start-->
	<div class="wlh-conbox">
		<div class="wlh-con">
			<h3>欢迎您，请先登录!</h3>
			<form action="/weixin/web/tg_vote_back/index.php/Admin/Login/login" method="post" name="myform">

				<div class="wlh-line">
					<p class="wlh-word">用<span style="margin-left:8px">户</span><span style="margin-left:8px">名:</span></p>
					<div class="wlh-text">
						<!--用户名输入-->
						<img src="/weixin/web/tg_vote_back/Public/image/usename-0.png" alt=""><input type="text" size="30" name="username">
					</div>
				</div>
				...
				<div class="wlh-line">
					...
					<div class="wlh-text">
						<!--密码输入-->
						<img src="/weixin/web/tg_vote_back/Public/image/password-0.png" alt=""><input type="password" name="password" size="30">
					</div>
				</div>
				<img src="/weixin/web/tg_vote_back/index.php/Admin/Login/verifyCodeImg" alt="" onclick="this.src='/weixin/web/tg_vote_back/index.php/Admin/Login/verifyCodeImg/'+Math.random()" >
				<div class="wlh-line">
